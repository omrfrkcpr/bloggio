...
const Preview: React.FC<PreviewProps> = ({
  ...
  useEffect(() => {
    ...
    if (category) {
      ...
      // Set the subcategory based on selected category if necessary
    }
  }, [desc, setDescription, image, category]);

  useEffect(() => {
    setPreview((prev) => ({ ...prev, categoryId: selectedSubcategory }));
    // Assuming selectedSubcategory is used elsewhere if needed
  }, [selectedSubcategory]);
        ...
        <div className="mt-[8rem] flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-[1] flex flex-col gap-4 mb-5 md:mb-0">
            ...
            <p className="text-gray-500 text-sm">
              Add or change category of your new blog so readers know what your
              blog is about
            </p>
            <BlogCategory
            ...
            />
            <BlogTagInput setPreview={setPreview} tags={preview?.tags || []} />
            <div className="flex gap-3 items-center mt-1 pt-5 border-t border-gray-400">
              ...
              <div
                ...
                className={`flex-[1] text-md flex h-[220px] flex-col gap-5 justify-start items-center border hover:border-black p-4 cursor-pointer ${
                  publishType === "publish" ? "border-black" : "border-gray-300"
                }`}
              >
